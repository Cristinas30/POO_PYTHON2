class Empleado:
    def __init__(self,nombre,tareas):
        ...
        self.nombre=nombre
        self.tareas=[] # aqui lo guartdo en listas []
        
    def asignar_tarea(self,tarea):
        self.tareas.append(tarea)# aqui adiciono con append las tareas y las guardo en la lista tarea
        
    def realizar_tarea(self):
        print (f"{self.nombre},esta desarrollando las siguientes tareas") #self.nombre llama el nombre del empleado
