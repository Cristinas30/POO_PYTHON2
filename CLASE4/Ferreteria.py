...
#PATRON SINGLETON tengo mi singleton y unos metodos de facturacion o pedido
...
if __name__ == "__main__":
    ...
    for operacion in sistema_facturacion.historial:
        print(f"Transacción: {operacion}")
            ...
            #el metodo appened es que el que me registra
            # forma parte de un diseño estructuralel @ abstractmethod